...
This is the density plot showing the patient's status (0 = alive, 1 = death) of each comorbities. 
...
renderPlotly({
    ...
    pca_coord = PCA(sign_tidy |> select(variable), scale.unit = TRUE, graph = FALSE)
