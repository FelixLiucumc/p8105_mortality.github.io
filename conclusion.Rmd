...
Due to the response variable being binary, we employed the logistic regression method. Before the regrassion process, the data types of categorical variables will be transformed to factor.
